# Legacy README Patch Note

This file is retained only as an archival reference for earlier README drafting.

It is not the canonical product description for the current public release.
