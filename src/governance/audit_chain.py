...
# IOA Module: src/governance/audit_chain.py
# Version: v2.5.0
# Last-Updated: 2025-08-19
# Agents: Cursor assist
# Summary: Immutable hash-chained audit log with jsonschema validation
...
class AuditEntry:
    ...
    def materialize(self) -> Dict[str, Any]:
        ...
        from src.audit.canonical import canonicalize_json, compute_hash
