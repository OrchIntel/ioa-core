...
"""
IOA Module: src/llm_providers/factory.py
Version: v2.5.0
Last-Updated: 2025-08-16
Agents: Cursor assist
Summary: Factory for creating LLM service providers with precedence resolution
"""
...
def create_provider(provider: str, model: Optional[str] = None, *, 
...
def _create_provider_instance(provider: str, model: Optional[str], 
