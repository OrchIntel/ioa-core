...
# Module: agent_onboarding.py | Version: v2.4.8 | License: Apache-2.0
...
# IOA Module: src/agent_onboarding.py
# Version: v2.5.0
# Last-Updated: 2025-08-19
# Agents: Cursor assist
# Summary: Agent onboarding system with PKI manifest signing and verification
...
class AgentOnboarding:
    ...
    def __init__(self, 
        ...
        self._onboarded_agents: Dict[str, AgentManifest] = {}
    ...
    def onboard_agent(self, manifest_data: Dict[str, Any]) -> OnboardingResult:
        ...
        with self._lock:
            try:
                ...
                self._onboarding_history.append(result)
                self.logger.info(f"Successfully onboarded agent: {agent_id}")
    ...
    def _validate_tenant_isolation(self, manifest: AgentManifest) -> bool:
        ...
        if manifest.agent_id in self._onboarded_agents:
    ...
    def _register_agent(self, manifest: AgentManifest) -> None:
        ...
        if manifest.tenant_id not in self._tenant_agents:
    ...
    # PATCH: Cursor-2025-08-19 DISPATCH-GPT-20250819-022 <add PKI functionality for integration wiring>
    def issue_manifest(self, agent_id: str, capabilities: List[str], version: str = "1.0.0") -> Dict[str, Any]:
        """
