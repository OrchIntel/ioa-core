...
# IOA Module: src/cli/errors.py
# Version: v2.5.0
# Last-Updated: 2025-09-04
# Agents: Cursor assist
# Summary: Custom exception classes for CLI operations
...
class NonInteractiveError(Exception):
    ...
    def __init__(self, message: str = "Interactive operation not allowed in non-interactive environment"):
