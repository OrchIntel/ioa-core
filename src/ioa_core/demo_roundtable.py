...
# IOA Module: src/ioa_core/demo_roundtable.py
# Version: v2.5.0
# Last-Updated: 2025-09-08
# Agents: Cursor assist
# Summary: Multi-agent roundtable demo for EcoLens pitch creation
...
def _estimate_cost_usd(provider_id: str, model: str, tokens_in: int, tokens_out: int) -> float:
...
def _run_provider_call(provider_id: str, model: str, prompt: str, timeout_ms: int, 
...
def _generate_demo_report(agent_results: Dict[str, Dict[str, Any]], 
    ...
    try:
        ...
        report_content = f"""<!-- IOA Module: {report_path} -->
<!-- Version: v2.5.0 -->
...
---
*Generated by IOA Core v2.5.0 Roundtable Demo System*
"""
...
def run_roundtable_demo(timeout_ms: int = 12000, max_usd: float = 0.10, 
    ...
    try:
        ...
        click.echo(f"📊 Demo Summary:")
        click.echo(f"  Agents: {passed} passed, {skipped} skipped, {failed} failed")
