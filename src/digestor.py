...
# Module: digestor.py | Version: v2.4.8 | License: Apache-2.0
...
class DigestorCore:
    ...
    def __init__(
        ...
        Args:
            ...
            version: Processing version identifier for tracking
...
def create_digestor(
    ...
    Args:
        ...
        config: Optional digestor configuration (uses defaults if None)
        version: Digestor version identifier for tracking
