...
"""
IOA Module: src/roundtable_executor.py
Version: v2.5.0
Last-Updated: 2025-08-18
Agents: Cursor assist
Summary: Production-grade Roundtable Executor with multi-agent consensus engine and universal JSON logging
"""
...
class RoundtableExecutor:
    ...
    async def execute_roundtable(
        ...
        **kwargs
        ...
        Args:
            ...
            agents: List of agent IDs to use (defaults to all available)
    ...
    async def _execute_agents(self, task: str, agents: List[str], timeout: float) -> List[VoteRecord]:
    ...
    def _calculate_quorum_threshold(self, agents: List[str], quorum_ratio: float) -> int:
